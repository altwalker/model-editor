...
module('Integration | Component | minimize-icon', function(hooks) {
  setupRenderingTest(hooks);

  test('it renders', async function(assert) {
    await render(hbs`<MinimizeIcon />`);
  ...
  test('it should sets size', async function(assert) {
    ...
    await render(hbs`<MinimizeIcon @size={{this.size}} />`);
  ...
  test('it should sets the color', async function(assert) {
    ...
    await render(hbs`<MinimizeIcon @color={{this.color}} />`);
  ...
  test('it should sets the stroke-width', async function(assert) {
    ...
    await render(hbs`<MinimizeIcon @strokeWidth={{this.strokeWidth}} />`);
