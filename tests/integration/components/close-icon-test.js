...
module('Integration | Component | close-icon', function(hooks) {
  setupRenderingTest(hooks);

  test('it renders', async function(assert) {
    await render(hbs`<CloseIcon />`);
  ...
  test('it should sets size', async function(assert) {
    ...
    await render(hbs`<CloseIcon @size={{this.size}} />`);
  ...
  test('it should sets the color', async function(assert) {
    ...
    await render(hbs`<CloseIcon @color={{this.color}} />`);
